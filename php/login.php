        ...
        <div id="loginPopup" class="fixed z-10 inset-0 overflow-y-auto hidden">
            <div id="loginForm" class="bg-white rounded-lg shadow-lg w-1/3 mx-auto mt-20 p-6">
                <form action="" method="post">
                    ...
                    <input type="text" id="username" name="username" class="border rounded w-full py-2 px-3 text-grey-darker mb-3">
                    <label for="password" class="font-bold mb-2 block">Password:</label>
                    <input type="password" id="password" name="password" class="border rounded w-full py-2 px-3 text-grey-darker mb-3">
                    <input type="submit" value="Login" class="bg-green-500 hover:bg-orange-500 text-white font-bold py-2 px-4 rounded cursor-pointer">
                </form>
                <?php if (isset($error)): ?>
